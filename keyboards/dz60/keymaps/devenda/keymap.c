...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_AZ] = LAYOUT_directional(
        ...
        LSFT_T(BE_LABK), BE_W, BE_X, BE_C, BE_V, BE_B, BE_N, BE_COMM, BE_SCLN, BE_COLN, BE_EQL, RSFT_T(BE_EQL), KC_UP, KC_DEL, 
    ...
    [_QW] = LAYOUT_directional(
        ...
        MO(_QWS), BE_Z, BE_X, BE_C, BE_V, BE_B, BE_N, BE_M, BE_COMM, BE_DOT, BE_SLSH, LT(_QWS, BE_SLSH), KC_UP, KC_DEL, 
