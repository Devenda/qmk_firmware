...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LO] = LAYOUT_planck_mit(
    ...
    _______, _______, _______, _______, _______, _______, _______, KC_UNDS, KC_PLUS, TD(TD_LPRN), TD(TD_RPRN), BE_MINS,
  ...
  [_RA] = LAYOUT_planck_mit(
    ...
    _______, BE_LABK, BE_RABK, _______, _______, _______, _______, BE_MINS, BE_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
 ...
 [_FU] = LAYOUT_planck_mit(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,       _______, _______,
    _______, _______, _______, _______, _______,     _______,      _______, _______, LCTL(BE_MINS), _______, LCTL(BE_PLUS)) 
};
